    ...
    < div class="header" >
        <h1>${Lang.t('settings')}</h1>
            ...
            <div class="card">
                ...
                <div class="list-item" onclick="Store.logout()">
                    <div class="flex-row" style="width: 100%;">
                        <span class="text-red">${Lang.t('logout')}</span>
...
`;
    ...
    renderLogin() {
        return `
    < div style = "display: flex; flex-direction: column; justify-content: center; height: 100vh; padding: 20px;" >
                <h1 style="text-align: center; margin-bottom: 40px;">${Lang.t('app_name')}</h1>
                
                <div class="card">
                    <h2 style="text-align: center;">${Lang.t('login')}</h2>
                    <form onsubmit="app.handleLogin(event)">
                        ...
                        <button type="submit" class="btn">${Lang.t('login')}</button>
                    </form>
                    <div style="text-align: center; margin-top: 16px;">
                        <button class="btn btn-secondary" onclick="app.showRegister()">${Lang.t('register')}</button>
                    </div>
                </div>
                
                <div style="text-align: center; margin-top: 20px;">
                    <button class="btn btn-secondary" style="width: auto; display: inline-flex;" onclick="Lang.setLanguage(Lang.current === 'ar' ? 'en' : 'ar')">
    ...
    < div style = "display: flex; flex-direction: column; justify-content: center; height: 100vh; padding: 20px;" >
                ...
                <div class="card">
                    <h2 style="text-align: center;">${Lang.t('register')}</h2>
                    <form onsubmit="app.handleRegister(event)">
                        ...
                        <button type="submit" class="btn">${Lang.t('register')}</button>
                    </form>
                    <div style="text-align: center; margin-top: 16px;">
                        <button class="btn btn-secondary" onclick="app.showLogin()">${Lang.t('cancel')}</button>
                    </div>
                </div>
            </div >
    `;
