...
const app = {
    ...
    showLogin() {
        ...
        document.getElementById('main-content').innerHTML = UI.renderLogin();
    },

    showRegister() {
        document.getElementById('tab-bar').style.display = 'none';
        document.getElementById('main-content').innerHTML = UI.renderRegister();
    },
    ...
    handleLogin(event) {
        ...
        if (Store.login(data.username, data.password)) {
            // Success handled by authChanged event
        } else {
            alert(Lang.t('login_error') || 'Invalid username or password');
        }
    },
    ...
    handleRegister(event) {
        ...
        if (Store.register(data.username, data.password)) {
            // Success handled by authChanged event
        } else {
            alert(Lang.t('register_error') || 'User already exists');
        }
    },
